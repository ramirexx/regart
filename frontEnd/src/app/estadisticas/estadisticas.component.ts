        ...
        this.formularioService.getDeptoIndividual()
            ...
            this.lista1 = data
                for (let i = 0; i < this.lista1.length; i++) {
                    ...
                    this.totalDeptos += totalNumber;
                    console.log("TOTAL" + this.totalDeptos);

                    let suma = 0;
                    for (let i = 0; i < this.deptoTotal.length; i++) {
                        suma += this.deptoTotal[i];
                        this.totalDeptos = suma;
                    }
                }
            },
                err => console.log(err),
